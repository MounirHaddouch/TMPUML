...
public class TPUML {
	...
	// 
	static ArrayList<Unit> units_list = new ArrayList<Unit>();		// contains the Units created
	static ArrayList<String> convs_list = new ArrayList<String>();  // contains the complex conversions
